            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  />
                  <h3 className="text-md font-semibold text-center">{member.name}</h3>
                  <p className="text-sm text-gray-400 text-center">{member.role}</p>
                  <p className="text-xs text-gray-500 mt-2 text-center">{member.bio}</p>
                  <div className="flex justify-center space-x-4 mt-4">
                    <a href={member.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-400">
                    ...
                    <a href={member.social.github} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
